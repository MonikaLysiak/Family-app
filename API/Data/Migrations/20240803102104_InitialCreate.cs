        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Surame = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUsersFamilies", x => new { x.FamilyId, x.UserId });
                    table.ForeignKey(
                        name: "FK_AppUsersFamilies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUsersFamilies_Families_FamilyId",
                        column: x => x.FamilyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FamilyPhotos_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FamilyPhotos_Families_FamilyId",
                        column: x => x.FamilyId,
                        principalTable: "Families",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invitations", x => new { x.FamilyId, x.InviteeUserId, x.InviterUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsersFamilies_UserId",
                table: "AppUsersFamilies",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyPhotos_AuthorId",
                table: "FamilyPhotos",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_FamilyPhotos_FamilyId",
                table: "FamilyPhotos",
                column: "FamilyId");
