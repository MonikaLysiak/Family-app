...
@Component({
  selector: 'app-photo-edytor',
  templateUrl: './photo-edytor.component.html',
  styleUrls: ['./photo-edytor.component.css']
})
export class PhotoEdytorComponent implements OnInit {
